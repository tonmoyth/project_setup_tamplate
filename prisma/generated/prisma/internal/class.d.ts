 ...
 * `prisma.friend`: Exposes CRUD operations for the **Friend** model.
  ...
  */
     ...
     * `prisma.videoReaction`: Exposes CRUD operations for the **VideoReaction** model.
      ...
      * ```
      */
    get videoReaction(): Prisma.VideoReactionDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.videoReport`: Exposes CRUD operations for the **VideoReport** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more VideoReports
      * const videoReports = await prisma.videoReport.findMany()
      * ```
      */
    get videoReport(): Prisma.VideoReportDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     ...
     * `prisma.storyTag`: Exposes CRUD operations for the **StoryTag** model.
      ...
      * ```
      */
    get storyTag(): Prisma.StoryTagDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
